...
class GUI:
    ...
    def layout(self,name):
     ...
     self.btn = Button(self.labelBottom, text = "Send", font = "Helvetica 10 bold", width = 20, bg = "#abb2b9", command = lambda : self.sendButton(self.entryMessage.get()))
     self.btn.place(relx = 0.77, rely = 0.008, relheight = 0.06, relwidth = 0.22)        
